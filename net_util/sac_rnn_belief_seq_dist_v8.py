...
class SACRNNBeliefSeqDistV8(PolicyBase):
    ...
    def __init__(self, cmd_cls: Any, cfg: SACRNNBeliefSeqDistV8_Config, rollout_buffer: RNNPriReplayBuffer2 | None = None, device: str | None = None, state_transform_dict: dict | None = None, reward_cfg: Optional[dict] = None):
