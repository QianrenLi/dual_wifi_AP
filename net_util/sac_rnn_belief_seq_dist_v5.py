...
@register_policy_cfg
@dataclass
class SACRNNBeliefSeqDistV5_Config:
    # Core RL Parameters
    batch_size: int = 256
...
@register_policy
class SACRNNBeliefSeqDistV5(PolicyBase):
    """Refactored Soft Actor-Critic (SAC) with RNN and Learned Belief State."""

    def __init__(self, cmd_cls: Any, cfg: SACRNNBeliefSeqDistV5_Config, rollout_buffer: RNNPriReplayBuffer2 | None = None, device: str | None = None, state_transform_dict: dict | None = None, reward_cfg: Optional[dict] = None):
